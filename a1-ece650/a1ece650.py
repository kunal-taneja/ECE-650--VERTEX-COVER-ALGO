...
def generate_graph():
                    ...
                    if (determinant != 0):
                        ...
                        if (flag1 == True & flag2 == True):
                            ...
                            for z in range(0, len(list_vertices_of_intersecting_lines)):
                                final_vertices[z + 1] = list_vertices_of_intersecting_lines[z]
                        else:
                            pass
                    elif(pair1==pair4):
    ...
    sys.stdout.write( "V = {" + '\n')
    for x, y in final_vertices.items():
    ...
    for b in range(0, len(list_intersection)):
        ...
        for c in final_vertices:

            if intersection_pt == final_vertices[c]:
                edge_intersection = c
        for st, gps in final_vertices.items():
            if gps == pair1:
